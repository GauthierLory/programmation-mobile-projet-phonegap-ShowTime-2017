    ...
    listeElement = null;
      ...
      initialiser = function (){
	        if (!listeElement && localStorage['element'])
	        {
	            ...
	            {
	                elementAnonyme = listeAnonyme[indiceAnonyme];
	                element = new Element(elementAnonyme.nom,
	                                    elementAnonyme.synopsis,
	                                    elementAnonyme.photo,
	                                    elementAnonyme.date,
	                                    elementAnonyme.categorie,
	                                    elementAnonyme.genre,
	                                    elementAnonyme.email,
	                                    elementAnonyme.note,
	                                    elementAnonyme.id);
