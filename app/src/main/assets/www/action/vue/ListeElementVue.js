var ListeElementVue = function(listeElement)
{
    this.afficher = function()
    {
        ...
        for (var indiceElement in listeElement)
            {
                if (actif == 1){
                    slideAffiche += '<div class="carousel-item active"><a href="#element/' +listeElement[indiceElement].id +'"><img class="rounded mx-auto d-block img-fluid" src="'+listeElement[indiceElement].url+'" alt="First slide"/></a><div class="carousel-caption d-none d-block"><a id="bouton" class="btn btn-warning animated rubberBand" href="#modifier-element/' +listeElement[indiceElement].id + '">Modifier</a></div></div>';
                    var actif = 0;
                }else{
                    slideAffiche += '<div class="carousel-item"><a href="#element/' +listeElement[indiceElement].id +'"><img class="rounded mx-auto d-block img-fluid" src="'+listeElement[indiceElement].url+'" alt="First slide"/></a><div class="carousel-caption d-none d-block"><a id="bouton" class="btn btn-warning animated rubberBand" href="#modifier-element/' +listeElement[indiceElement].id + '">Modifier</a></div></div>';
